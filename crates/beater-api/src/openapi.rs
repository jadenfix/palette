...
#[openapi(
    ...
    paths(
        ...
        crate::routes::api_keys::create_api_key_route,
        crate::routes::api_keys::revoke_api_key_route,
        crate::routes::provider_secrets::list_provider_secrets_route,
        crate::routes::provider_secrets::create_provider_secret_route,
        crate::routes::provider_secrets::revoke_provider_secret_route,
