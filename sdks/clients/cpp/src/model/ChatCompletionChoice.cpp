...
void ChatCompletionChoice::validate()
{
    // TODO: implement validation
}

web::json::value ChatCompletionChoice::toJson() const
{
...
bool ChatCompletionChoice::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("message"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ChatMessage> refVal_setMessage;
...
void ChatCompletionChoice::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ChatCompletionChoice::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t ChatCompletionChoice::getFinishReason() const
{
    return m_Finish_reason;
}


void ChatCompletionChoice::setFinishReason(const utility::string_t& value)
{
    m_Finish_reason = value;
    m_Finish_reasonIsSet = true;
}

bool ChatCompletionChoice::finishReasonIsSet() const
{
    return m_Finish_reasonIsSet;
}

void ChatCompletionChoice::unsetFinish_reason()
{
    m_Finish_reasonIsSet = false;
}
int32_t ChatCompletionChoice::getIndex() const
{
    return m_Index;
}

void ChatCompletionChoice::setIndex(int32_t value)
{
    m_Index = value;
    m_IndexIsSet = true;
}

bool ChatCompletionChoice::indexIsSet() const
{
    return m_IndexIsSet;
}

void ChatCompletionChoice::unsetIndex()
{
    m_IndexIsSet = false;
}
std::shared_ptr<ChatMessage> ChatCompletionChoice::getMessage() const
{
    return m_Message;
}


void ChatCompletionChoice::setMessage(const std::shared_ptr<ChatMessage>& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool ChatCompletionChoice::messageIsSet() const
{
    return m_MessageIsSet;
}

void ChatCompletionChoice::unsetMessage()
{
    m_MessageIsSet = false;
}
