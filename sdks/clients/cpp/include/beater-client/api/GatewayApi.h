...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_GatewayApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_GatewayApi_H_
...
public:
    ...
    /// <param name="gatewayChatHttpRequest"></param>
    ...
    pplx::task<std::shared_ptr<GatewayOutcome>> gatewayChatCompletions(
        utility::string_t tenantId,
        utility::string_t projectId,
        utility::string_t environmentId,
        std::shared_ptr<GatewayChatHttpRequest> gatewayChatHttpRequest,
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_GatewayApi_H_ */
